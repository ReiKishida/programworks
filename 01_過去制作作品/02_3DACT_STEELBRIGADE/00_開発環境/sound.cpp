...
SOUNDPARAM g_aSoundParam[SOUND_LABEL_MAX] =
{
	...
	{ "data/BGM/game000.wav", -1 },	// ミッション01_BGM
	{ "data/BGM/result.wav", -1 },	// リザルト
	{ "data/BGM/tuto.wav", -1 },	// 操作画面
	{ "data/BGM/world00.wav", -1 },	// BGM3
	{ "data/BGM/br.wav", -1 },	// ブリーフィング
	{ "data/SE/shot.wav", 0 },		// ショット
	{ "data/SE/bomb.wav", 0 },		// ショット
	{ "data/SE/quick2.wav", 0 },	// Bクイック
	{ "data/SE/land.wav", 0 },	// B着地
	{ "data/SE/steam.wav", 0 },	// syu-
	{ "data/SE/land2.wav", 0 },	//歩行
	{ "data/SE/biri.wav", 0 },	//ﾋﾞﾘﾋﾞﾘ
	{ "data/SE/setup.wav", 0 },	//立ち上がり
	{ "data/SE/decide002.wav", 0 }	// 選択音
};
