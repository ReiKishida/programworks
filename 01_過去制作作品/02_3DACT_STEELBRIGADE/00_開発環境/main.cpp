...
#define WINDOW_NAME		"STEEL BRIGADE "	// ウインドウのキャプション名
...
//MODE g_mode = MODE_TIPS;				//現在のモード
//MODE g_mode = MODE_GAME;				//現在のモード
//MODE g_mode = MODE_WORLD;				//現在のモード
