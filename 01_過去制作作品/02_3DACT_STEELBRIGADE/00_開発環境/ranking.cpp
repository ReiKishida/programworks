...
// マクロ定義
//*****************************************************************************
#define	TEXTURE_RANKING		"data/TEXTURE/number002.png"	// 読み込むテクスチャファイル名
...
int				g_nRanking[MAX_RANKING] = { 150000, 100000, 85000, 60000, 35000 };	// スコア
...
void MakeVertexRanking(LPDIRECT3DDEVICE9 pDevice)
{
	...
	// 頂点バッファを生成
	pDevice->CreateVertexBuffer(sizeof(VERTEX_2D) * 4 * 8 * (MAX_RANKING + 1),
		D3DUSAGE_WRITEONLY,
		FVF_VERTEX_2D,
		D3DPOOL_MANAGED,
		&g_pVtxBuffRanking,
