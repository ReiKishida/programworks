...
void InitTitle(void)
{
	...
	//SetFg(D3DXVECTOR3(270, 660, 0.0f), 0, 75, 150);
	//SetFg(D3DXVECTOR3(810, 660, 0.0f), 0, 75, 150);
	//SetFg(D3DXVECTOR3(1100, 650, 0.0f), 0, 75, 150);
	SetFg2(D3DXVECTOR3(-10, 645, 0.0f), 4, 250, 120);
	SetFg2(D3DXVECTOR3(SCREEN_WIDTH + 10, 645, 0.0f), 5, 250, 120);

	//発射位置の設置
	SetShoot(D3DXVECTOR3(SCREEN_WIDTH / 2, -10 - 150, 0.0f));
	//SetShoot(D3DXVECTOR3(-SCREEN_WIDTH / 2, SCREEN_HEIGHT , 0.0f));
...
void UpdateTitle(void)
{
	...
	if (g_aTitle[0].fLength < 420)
	{
		...
		{
			//PlaySound(SOUND_LABEL_SE_DRAMA);
