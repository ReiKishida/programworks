...
#define MINUTES_HEIGHT (40.0f)

#define SECONDS_WIDTH (20.0f)
#define SECONDS_HEIGHT (30.0f)
...
HRESULT CGameTimer::Init(void)
{
	...
	for (int nCntNumber = 0; nCntNumber < TIMER_NUMBER; nCntNumber++)
	{
		...
		case CTimer::TIMERTYPE_ONEMINUTE:
			//1分台
			//数字の生成
			m_apNumber[nCntNumber] = CNumber::Create(D3DXVECTOR3(m_pos.x + 40.0f, m_pos.y, m_pos.z), MINUTES_WIDTH, MINUTES_HEIGHT);
			break;

		case CTimer::TIMERTYPE_TENSECONDS:
			//10秒台
			//数字の生成
			m_apNumber[nCntNumber] = CNumber::Create(D3DXVECTOR3(m_pos.x + 90.0f, m_pos.y + 5.0f, m_pos.z), SECONDS_WIDTH, SECONDS_HEIGHT);
			break;
		case CTimer::TIMERTYPE_ONESECONDS:
			//1秒台
			//数字の生成
			m_apNumber[nCntNumber] = CNumber::Create(D3DXVECTOR3(m_pos.x + 125.0f, m_pos.y + 5.0f, m_pos.z), SECONDS_WIDTH, SECONDS_HEIGHT);
			break;
		case CTimer::TIMERTYPE_TENCOMMASECONDS:
			//10コンマ秒
			//数字の生成
			m_apNumber[nCntNumber] = CNumber::Create(D3DXVECTOR3(m_pos.x + 170.0f, m_pos.y + 10.0f, m_pos.z), COMMA_WIDTH, COMMA_HEIGHT);
			break;
		case CTimer::TIMERTYPE_ONECOMMASECONDS:
			//1コンマ秒
			//数字の生成
			m_apNumber[nCntNumber] = CNumber::Create(D3DXVECTOR3(m_pos.x + 200.0f, m_pos.y + 10.0f, m_pos.z), COMMA_WIDTH, COMMA_HEIGHT);
			break;
		}
	}
...
HRESULT CResultTimer::Init()
{
	for (int nCntNumber = 0; nCntNumber < TIMER_NUMBER; nCntNumber++)
	{
		...
		case CTimer::TIMERTYPE_TENMINUTE:
			//10分台
			//数字の生成
			m_apNumber[nCntNumber] = CNumber::Create(D3DXVECTOR3(m_pos.x, m_pos.y, m_pos.z), SECONDS_WIDTH, SECONDS_HEIGHT);
			break;
		case CTimer::TIMERTYPE_ONEMINUTE:
			//1分台
			//数字の生成
			m_apNumber[nCntNumber] = CNumber::Create(D3DXVECTOR3(m_pos.x + 40.0f, m_pos.y, m_pos.z), SECONDS_WIDTH, SECONDS_HEIGHT);
			break;

		case CTimer::TIMERTYPE_TENSECONDS:
			//10秒台
			//数字の生成
			m_apNumber[nCntNumber] = CNumber::Create(D3DXVECTOR3(m_pos.x + 100.0f, m_pos.y + 5.0f, m_pos.z), SECONDS_WIDTH, SECONDS_HEIGHT);
			break;
		case CTimer::TIMERTYPE_ONESECONDS:
			//1秒台
			//数字の生成
			m_apNumber[nCntNumber] = CNumber::Create(D3DXVECTOR3(m_pos.x + 135.0f, m_pos.y + 5.0f, m_pos.z), SECONDS_WIDTH, SECONDS_HEIGHT);
			break;
		case CTimer::TIMERTYPE_TENCOMMASECONDS:
			//10コンマ秒
			//数字の生成
			m_apNumber[nCntNumber] = CNumber::Create(D3DXVECTOR3(m_pos.x + 190.0f, m_pos.y + 10.0f, m_pos.z), COMMA_WIDTH, COMMA_HEIGHT);
			break;
		case CTimer::TIMERTYPE_ONECOMMASECONDS:
			//1コンマ秒
			//数字の生成
			m_apNumber[nCntNumber] = CNumber::Create(D3DXVECTOR3(m_pos.x + 220.0f, m_pos.y + 10.0f, m_pos.z), COMMA_WIDTH, COMMA_HEIGHT);
			break;
		}
	}
