...
//敵のクラス宣言
//*****************************************************************************
class CEnemyTrick : public CScene
{
public:
	//キー要素
	typedef struct
	...
	CEnemyTrick(int nPriority = 1, OBJTYPE type = OBJTYPE_ENEMY_TRC);	// コンストラクタ
	~CEnemyTrick();													// デストラクタ
	static HRESULT Load(void);									// テクスチャの読み込み
	static void Unload(void);									// テクスチャの破棄
	static CEnemyTrick *Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float fLife, ENEMYTYPE type);		// 敵の生成
