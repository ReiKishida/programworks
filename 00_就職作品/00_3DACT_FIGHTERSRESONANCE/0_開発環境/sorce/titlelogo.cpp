...
// マクロ定義
//*****************************************************************************
#define LOGO_WIDTH (700.0f)	//タイトルロゴの幅
#define LOGO_HEIGHT (350.0f) //タイトルロゴのYの高さ
...
//コンストラクタ
//=============================================================================
CTitleLogo::CTitleLogo() : CScene(7)
{
}
...
HRESULT CTitleLogo::Load(void)
{
	...
	// テクスチャの生成
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/logo/title.png", &m_apTexture[0]);			//タイトルロゴ[パターン1]
...
HRESULT CTitleLogo::Init(void)
{
	...
	for (int nCntTitle = 0; nCntTitle < MAX_TITLE_NUM; nCntTitle++)
	{
		...
		case TITLETYPE_LOGO:
			//2Dポリゴンの生成
			m_apScene2D[nCntTitle] = CScene2D::Create(D3DXVECTOR3(SCREEN_WIDTH / 2, 250.0f, 0.0f), LOGO_WIDTH, LOGO_HEIGHT);
			//タイトルの種類の設定
