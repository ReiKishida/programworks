...
HRESULT CLight::Init(void)
{
	...
	// ライトの拡散光を設定
	m_Light[0].Diffuse = D3DXCOLOR(1.0f, 1.0f, 1.0f, 0.8f);
	m_Light[1].Diffuse = D3DXCOLOR(0.82f, 0.82f, 0.82f, 0.85f);
	m_Light[2].Diffuse = D3DXCOLOR(0.5f, 0.5f, 0.5f, 0.7f);

	// ライトの方向の設定
	vecDir0 = D3DXVECTOR3(0.4f, -0.7f, 0.4f);
	D3DXVec3Normalize(&vecDir0, &vecDir0);

	vecDir1 = D3DXVECTOR3(-0.3f, 0.8f, -0.5f);
	D3DXVec3Normalize(&vecDir1, &vecDir1);

	vecDir2 = D3DXVECTOR3(-0.5f, -0.8f, 0.0f);
